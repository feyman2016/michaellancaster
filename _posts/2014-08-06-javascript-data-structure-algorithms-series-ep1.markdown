...
Web applications has evolved to a much complex system and with that Developers/Engineers are being "forced" to evolve (could be the other way around) applying concepts of pure Computer Science which before you would just see on systems/programs using languages as such C, C++, Java and so on.
...
I'm not a Computer Scientist and these Series of posts wont be very advanced but I'm sure it will be worth it.
